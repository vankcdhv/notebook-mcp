...
```bash
curl -sSL https://raw.githubusercontent.com/vankcdhv/notebook-mcp/main/install.sh | sh -s -- v0.3.0
```

```powershell
$env:NOTEBOOKLM_MCP_VERSION="v0.3.0"; iwr -useb https://raw.githubusercontent.com/vankcdhv/notebook-mcp/main/install.ps1 | iex
```
